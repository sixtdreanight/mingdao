...
这条路的核心赌注是：一年高强度备考 → 三年研究生 → 大厂校招起薪 25-40k/月（比本科直接就业翻倍）。

## 真实画像

- **考研成功率**：双非考 211 约 15-25%，考 985 约 5-10%（计算机热门方向更低）
...
- 读研三年后就业市场可能已经变化`,
  constraints: [
    { id: 'economy', label: '经济可行性', description: '总投入 vs 家庭预算', assessment: 'pass', detail: '学费 2.4-4.5 万/3年，生活费另算。国家助学贷款可覆盖学费，研究生补贴（600-1500/月）可部分覆盖生活费。', sourceUrl: '' },
    { id: 'language', label: '语言能力', description: '该路径的最低语言要求', assessment: 'pass', detail: '考研英语一/二即可，不需要额外语言考试。外企就业需要 CET-6。', sourceUrl: '' },
    { id: 'degree-gate', label: '学历准入', description: '第一学历的真实竞争力', assessment: 'at-risk', detail: '双非一本考 211/985 计算机竞争激烈（报录比常超 10:1）。但考上后大厂校招不再卡第一学历。', sourceUrl: '' },
    ...
    { id: 'location-lock', label: '地域锁定', description: '上海岗位充足度', assessment: 'pass', detail: '上海高校资源丰富（复旦/交大/同济/华师大），毕业后本地就业岗位充足。', sourceUrl: '' },
    ...
    { id: 'living-standard', label: '生活水平底线', description: '就业初期的生活水平', assessment: 'at-risk', detail: '研究生期间生活费紧张（补贴 + 奖学金约 1000-2000/月），需要家庭支持或兼职。部分 985 专硕不提供宿舍。', sourceUrl: '' },
  ...
  trend: 'rising',
  trendDetail: '计算机考研热度持续上升，但大厂对硕士学历的偏好也在增强（AI/算法岗几乎只招硕士）。考研内卷意味着投入产出比在下降，但研究生学历的长期溢价仍然显著。',
  exclusivity: ['放弃 3-4 年工作经验和收入', '放弃本科应届进大厂的机会窗口', '承担考研失败的心理和时间成本', '放弃本科毕业即经济独立的可能性'],
  actionPlan: [
    { year: '大一上', tasks: ['学好高数、线代、概率论（考研数学一的基础）', '学好 C 语言和数据结构', '了解目标院校的考研科目和分数线'] },
    { year: '大一下', tasks: ['保持高 GPA（保研资格是 Plan A，考研是 Plan B）', '系统学习考研数学基础', '暑假：开始背考研英语单词'] },
    { year: '大二上', tasks: ['争取参与科研项目或大创项目（复试加分项）', '明确目标院校（1 个冲刺 + 2 个稳妥）', '学习计算机专业课：操作系统、计算机网络、组成原理'] },
    { year: '大二下', tasks: ['通过 CET-6（550+ 更好）', '参加一个学科竞赛（ACM/蓝桥杯/数学建模）', '暑假：开始系统刷考研数学全书'] },
    { year: '大三上', tasks: ['正式开始考研复习（数学 + 英语为主）', '确定目标院校并联系学长学姐获取真题', '关注夏令营信息（985 夏令营对双非有限制但可尝试）'] },
    { year: '大三下', tasks: ['全力冲刺考研复习（日均 8-10 小时）', '政治开始复习', '报名考研（9-10 月）', '同步投递秋招作为 Plan B（万一考研失败）'] },
  ...
  sourceUrls: ['https://yz.chsi.com.cn/', 'https://www.mohrss.gov.cn/（需补充具体就业报告链接）'],
